...
<video controls>
    <source src={video} type="video/mp4">
     <p>
        ...
        Voici <a href={video}>un lien pour télécharger la vidéo</a>.
     </p>
     </source>
</video>
