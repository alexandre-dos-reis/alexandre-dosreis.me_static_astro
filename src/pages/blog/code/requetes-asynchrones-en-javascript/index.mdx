---
title: "Requêtes asynchrones en javascript"
date: "20 Apr 2021"
draft: true
---
...
Cet article est une traduction d'un [lien StackOverflow](https://stackoverflow.com/questions/14220321/how-do-i-return-the-response-from-an-asynchronous-call) qui m'a permis de comprendre la nature asynchrone du moteur Javascript.

Quelle est la différence entre un code synchrone et asynchrone ?
...
Current [browser](https://kangax.github.io/compat-table/es2016plus/#test-async_functions) and [node](http://node.green/#ES2017-features-async-functions) versions support `async/await`. You can also support older environments by transforming your code to ES5 with the help of [regenerator](https://github.com/facebook/regenerator) (or tools that use regenerator, such as [Babel](https://babeljs.io/)).
...
Promises are containers for _future_ values. When the promise receives the value (it is _resolved_) or when it is canceled (_rejected_), it notifies all of its "listeners" who want to access this value.
...
If you directly use a [`XMLHttpRequest`](https://xhr.spec.whatwg.org/) object, pass `false` as third argument to [`.open`](https://xhr.spec.whatwg.org/#the-open()-method).
